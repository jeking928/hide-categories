...
TABLE_CATEGORIES . " c, " . TABLE_CATEGORIES_DESCRIPTION . " cd," . TABLE_HIDE_CATEGORIES . " cde
                          where c.categories_id=cd.categories_id and c.categories_id=cde.categories_id and c.parent_id= '0' and cd.language_id='" . (int)$_SESSION['languages_id'] . "' and c.categories_status='1' and cde.visibility_status < 2 OR cde.visibility_status IS NULL" . 
$order_by;
