...
<fieldset class="floatingBox back">
    ...
    <div class="floatLeft"><?php echo zen_draw_pull_down_menu('categories_id', HC_get_categories(array(array('id' => '', 'text' => TEXT_ALL_CATEGORIES)), '0' ,'', '1'), $sData['categories_id']);//hideCategories  echo zen_draw_pull_down_menu('categories_id', zen_get_categories(array(array('id' => '', 'text' => TEXT_ALL_CATEGORIES)), '0' ,'', '1'), $sData['categories_id']); ?></div>
